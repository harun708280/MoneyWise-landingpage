...
export const LampContainer = ({
  ...
  return (
    (<div
      className={cn(
        "relative flex min-h-[615px] flex-col items-center justify-center overflow-hidden  w-full  z-0",
        className
      )}>
      <div
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-blue-500  blur-2xl"></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
